/**
 * Server-side CRUD for the `tools` registry. Built-ins are seeded by the
 * agent on boot — they should NOT be mutated here (slug + handler
 * shape live in code). User-defined tools (http, future shell) flow
